 ...
 *  
 */
package com.gs.test.extract.javaprop;
...
public final class JpExtractor
{
    ...
    {
        String str_baseDir = "F:/CodeSource/workspace/gs_Head/main6/ling/";
        String str_fileName = "";
        ...
        try
        {
            if (args.length == 0)
            {
                str_fileName = str_baseDir + "test/javaprop/pc_regtest_en_US.properties";
            }
            else
            {
                str_fileName = args[0];
